-- Common
    ...
    Cut_percent_Full={} Cut_percent_Full[-1]="0%" for i=1,100 do Cut_percent_Full[i]=i.."%"end
...
-- Casino
    ...
    Casino_Cut_Gunman_offset = Global_Offset+26145   -- Global_262145.f_29023 1->5
    --
...
--Cayo
    ...
    Cayo_Cut_glass       = 29685+3               -- Cayo glass's offset                
