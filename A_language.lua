...
-- Lists and Variables
    ...
    -- Casino_Setup_Missions_List_0
        ...
        Casino_Setup_Missions_List_0_15 = {"[!]Yung Ancestors Gear","Outilages de Yung"}
        Casino_Setup_Missions_List_0_16 = {"Noose Gear            ","Outilages du NOOSE"}
        Casino_Setup_Missions_List_0_17 = {"Fire Fighter Gear     ","Outilages des pompiers"}
...
-- Cayo Setup
    ...
    -- Manual
        ...
        Cayo_Setup_Approach_Choose_list = {"-----------Choose at least one--------","-----------Choisir Au moins un----------"}
...
-- Cayo Set Loot
    ...
    -- IN
        Cayo_Setloot_Compound_in_list  = {"---------↓ Inside Compound ↓---------","---------↓ L'interieur de la cour ↓---------"}
    ...
    -- OUT
        Cayo_Setloot_Compound_out_list  = {"---------↓ Outside Compound ↓---------","---------↓ L'extérieur de la cour ↓---------"}
