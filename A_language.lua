...
-- Global / Multiple
    -- Cool
        ...
        Separator_text  = "__________________________________________"
        Half_Separator  = "______________"
    ...
    -- Cuts
        ...
        Cut_Crew           = {"Crew cuts","Pourcentage equipe"}
        Cut_Crew           = Arrow_Down1..Cut_Crew[current_language]..Arrow_Down2
...
-- Lists and Variables
    -- Casino_Setup_Missions_List_1
        ...
        Casino_Setup_Missions_List_1[0] = Casino_Setup_Missions_List_1[0][current_language]..Arrow_Right
        Casino_Setup_Missions_List_1[1] = Casino_Setup_Missions_List_1[1][current_language]..Arrow_Right
        Casino_Setup_Missions_List_1[2] = Casino_Setup_Missions_List_1[2][current_language]..Arrow_Right
        Casino_Setup_Missions_List_1[3] = Casino_Setup_Missions_List_1[3][current_language]..Arrow_Right
        Casino_Setup_Missions_List_1[4] = Casino_Setup_Missions_List_1[4][current_language]..Arrow_Right
        Casino_Setup_Missions_List_1[5] = Casino_Setup_Missions_List_1[5][current_language]..Arrow_Right
        Casino_Setup_Missions_List_1[6] = Casino_Setup_Missions_List_1[6][current_language]..Arrow_Right
        Casino_Setup_Missions_List_1[7] = Casino_Setup_Missions_List_1[7][current_language]..Arrow_Right
        Casino_Setup_Missions_List_1[8] = Casino_Setup_Missions_List_1[8][current_language]..Arrow_Right
        Casino_Setup_Missions_List_1[9] = Casino_Setup_Missions_List_1[9][current_language]..Arrow_Right
    -- Casino_Setup_Missions_List_0
        ...
        Casino_Setup_Missions_List_0[1]  = Casino_Setup_Missions_List_0[01][current_language]
        Casino_Setup_Missions_List_0[2]  = Casino_Setup_Missions_List_0[02][current_language]
        Casino_Setup_Missions_List_0[3]  = Casino_Setup_Missions_List_0[03][current_language]
        Casino_Setup_Missions_List_0[4]  = Casino_Setup_Missions_List_0[04][current_language]
        Casino_Setup_Missions_List_0[5]  = Casino_Setup_Missions_List_0[05][current_language]
        Casino_Setup_Missions_List_0[6]  = Casino_Setup_Missions_List_0[06][current_language]
        Casino_Setup_Missions_List_0[7]  = Casino_Setup_Missions_List_0[07][current_language]
        Casino_Setup_Missions_List_0[8]  = Casino_Setup_Missions_List_0[08][current_language]
        Casino_Setup_Missions_List_0[9]  = Casino_Setup_Missions_List_0[09][current_language]
    ...
    -- Casino_Approch_List
        ...
        Casino_Approch_List[1] = Silentnsneaky
        Casino_Approch_List[3] = Thebigcon
        Casino_Approch_List[5] = Aggressive
        for i=0,2 do
            for j=0,1 do
                Casino_Approch_List[2-j]  = Casino_Approch_List[2*i+1].."-"..Heist_difficulty_list[1+j]
            end
        end
...
-- Casino Setup
    ...
    Casino_Setup_Targetchoise = Casino_Setup_Targetchoise[current_language]..Arrow_Right
-- Casino Approach
    ...
    Casino_Approach_Choice  = Casino_Approach_Choise[current_language]..Arrow_Right
...
-- Common Missions
        ...
        Casino_Setup_Common_Passlevel = Casino_Setup_Common_Passlevel[current_language]..Arrow_Right
...
-- Lists and Variables
    ...
    -- Cayo_Loot_point
        ...
        Cayo_Setloot_Table1    = Cayo_Setloot_Table1[current_language]..White_space..Arrow_Right
        Cayo_Setloot_Table2    = Cayo_Setloot_Table2[current_language]..White_space..Arrow_Right
        Cayo_Setloot_Table3    = Cayo_Setloot_Table3[current_language]..White_space..Arrow_Right
        Cayo_Setloot_Painting1 = {"Painting","Tableau"}
        Cayo_Setloot_Painting2 = {"Painting 2","Tableau 2"}
        Cayo_Setloot_Painting1 = Cayo_Setloot_Painting1[current_language]..Arrow_Right
        Cayo_Setloot_Painting2 = Cayo_Setloot_Painting2[current_language]..Arrow_Right
        Cayo_Loot_point = {}
        -- Table 1
            for i = 0,3 do
...
-- Text
    ...
    Normal_Option         = {"Normal","Normal"}
    Law_Option            = {"Cops","Policier"}
    Cutscene_Option       = {"Cutscene","Cinématique"}
    Miscellaneous_text    = White_space..Miscellaneous_text[current_language]
    Miscellaneous_Options = "-  "..Miscellaneous_Options[current_language]
    Normal_Option         = "-  "..Normal_Option[current_language]
    Law_Option            = "-  "..Law_Option[current_language]
    Cutscene_Option       = "-  "..Cutscene_Option[current_language]
-- Options
    Tiny_Option                      = {"Tiny Player","Petit joueur"}
    Gender_option                    = {"Allow Gender Change","Possibilite de changer de genre"}
    ...
    Special_Option                   = {"Special","Special"}
    Tiny_Option                      = Tiny_Option[current_language]
    Gender_option                    = Gender_option[current_language]
    Multiplayer_Option               = Multiplayer_Option[current_language]..Arrow_Right
    Animal_Option                    = Animal_Option[current_language]..Arrow_Right
    Female_Character_Option          = Female_Character_Option[current_language]..Arrow_Right
    Male_Character_Option            = Male_Character_Option[current_language]..Arrow_Right
    Special_Option                   = Special_Option[current_language]..Arrow_Right
----
...
-- Main menu
    ...
    -- Noclip
        ...
        Menu_Noclip_Speed  = White_space..Menu_Noclip_Speed[current_language]
    ...
    -- Other's cool ppl script (modified)
        ...
        -- Gay Car
            ...
            Rainbow_Style   = Rainbow_Style[current_language]..Arrow_Right
    ...
    -- Other
        ...
        Menu_EnhancedOnline     = {"Enhanced online services","Services en ligne augmenté"}
        Menu_EnhancedOnline     = Half_Separator..Menu_EnhancedOnline[current_language]..Separator_text
...
-- Z_Global_Testet.lua
Global_Submenu = {"Global Tester","Testeur de globals"}
Global_Submenu = Global_Submenu[current_language]
-- Main
